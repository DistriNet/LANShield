...
object LANShieldIcons {
    ...
    val OpenInNewOutlined = Icons.AutoMirrored.Outlined.OpenInNew
    val ChevronRight = Icons.Rounded.ChevronRight
    val FeedbackOutlined = Icons.Outlined.Feedback
    val Mood = Icons.Rounded.Mood
    val SentimentVerySatisfied = Icons.Rounded.SentimentVerySatisfied
    ...
    val Export = Icons.Rounded.Share
    val Close = Icons.Rounded.Close
    val NotificationsActive = Icons.Rounded.NotificationsActive
    val Science = Icons.Rounded.Science
