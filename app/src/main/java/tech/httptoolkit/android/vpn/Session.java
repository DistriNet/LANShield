...
public class Session {
	...
	private final boolean ackedToFin = false;
	...
	public synchronized IPHeader getLastIpHeader() {
		return lastIpHeader;
	}
	synchronized void setLastIpHeader(IPHeader lastIpHeader) {
	...
	public static String getSessionKey(SessionProtocol protocol, IPAddress destIp, int destPort, IPAddress sourceIp, int sourcePort) {
	...
	public LANFlow getFlow() {
		return LANFlow;
	}

	public void setFlow(LANFlow LANFlow) {
		this.LANFlow = LANFlow;
	}
}
